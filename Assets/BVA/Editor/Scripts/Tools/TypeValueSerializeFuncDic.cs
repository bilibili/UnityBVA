...
namespace BVA
{
    public partial class MonoScriptExtraGenerator
    {
        ...
        public readonly static Dictionary<Type, Func<string, string>> TypeValueSerializeFuncDic = new Dictionary<Type, Func<string, string>>()
        {
            ...
            {typeof(Vector2), (a)=> $"{a}.ToGltfVector2Raw().ToJArray()"},
            {typeof(Vector3), (a)=>$"{a}.ToGltfVector3Raw().ToJArray()" },
            {typeof(Vector4), (a)=> $"{a}.ToGltfVector4Raw().ToJArray()"},
            {typeof(Rect), (a)=> $"{a}.ToGltfVector4Raw().ToJArray()"},
            {typeof(Quaternion), (a)=> $"{a}.ToGltfQuaternionRaw().ToJArray()"},
            {typeof(Color), (a)=> $"{a}.ToNumericsColorRaw().ToJArray()"},
        ...
        public readonly static Dictionary<Type, Func<Type, string>> JsonReaderDeSerializeFuncDic = new Dictionary<Type, Func<Type, string>>()
        {
            ...
            {typeof(Vector2), (a)=>  " reader.ReadAsVector2().ToUnityVector2Raw();"},
            {typeof(Vector3), (a)=>  " reader.ReadAsVector3().ToUnityVector3Raw();"},
            {typeof(Vector4), (a)=> $" reader.ReadAsVector4().ToUnityVector4Raw();"},
            {typeof(Rect), (a)=> $" reader.ReadAsVector4().ToUnityRectRaw();"},
            {typeof(Quaternion), (a)=> $" reader.ReadAsQuaternion().ToUnityQuaternionRaw();"},
            {typeof(Color), (a)=> $" reader.ReadAsRGBAColor().ToUnityColorRaw();"},
