...
namespace GLTF.Schema.BVA
{
    ...
    public delegate TextureId ExportTexture(Texture texture);
    public delegate SpriteId ExportSprite(Sprite sprite);
    public delegate MaterialId ExportMaterial(Material material);
    public delegate CubemapId ExportCubemap(Cubemap cubemap);
