...
{
public class BVA_Material_MToon_Extra : MaterialExtra
{
...
public MaterialParam<float> parameter_LightColorAttenuation = new MaterialParam<float>(LIGHTCOLORATTENUATION, 1.0f);
public MaterialParam<float> parameter_IndirectLightIntensity = new MaterialParam<float>(INDIRECTLIGHTINTENSITY, 1.0f);
...
public MaterialParam<float> parameter_RimLightingMix = new MaterialParam<float>(RIMLIGHTINGMIX, 1.0f);
public MaterialParam<float> parameter_RimFresnelPower = new MaterialParam<float>(RIMFRESNELPOWER, 1.0f);
public MaterialParam<float> parameter_RimLift = new MaterialParam<float>(RIMLIFT, 1.0f);
...
public MaterialParam<float> parameter_UVAnimationScrollX = new MaterialParam<float>(UVANIMSCROLLX, 1.0f);
public MaterialParam<float> parameter_UVAnimationScrollY = new MaterialParam<float>(UVANIMSCROLLY, 1.0f);
public MaterialParam<float> parameter_UVAnimationRotation = new MaterialParam<float>(UVANIMROTATION, 1.0f);
public MaterialParam<float> parameter__MToonVersion = new MaterialParam<float>(MTOONVERSION, 1.0f);
public MaterialParam<float> parameter__DebugMode = new MaterialParam<float>(DEBUGMODE, 1.0f);
public MaterialParam<float> parameter__BlendMode = new MaterialParam<float>(BLENDMODE, 1.0f);
public MaterialParam<float> parameter__OutlineWidthMode = new MaterialParam<float>(OUTLINEWIDTHMODE, 1.0f);
public MaterialParam<float> parameter__OutlineColorMode = new MaterialParam<float>(OUTLINECOLORMODE, 1.0f);
...
public MaterialParam<float> parameter__AlphaToMask = new MaterialParam<float>(ALPHATOMASK, 1.0f);
public BVA_Material_MToon_Extra(Material material, ExportTextureInfo exportTextureInfo, ExportTextureInfo exportNormalTextureInfo, ExportCubemapInfo exportCubemapInfo)
{
