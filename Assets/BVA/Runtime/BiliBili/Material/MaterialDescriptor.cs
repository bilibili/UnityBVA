...
namespace GLTF.Schema.BVA
{
    ...
    public static class MaterialFactory
    {
        ...
        private static readonly Dictionary<string, AsyncDeserializeCustomMaterial> CUSTOM_SHADER_LIST = new Dictionary<string, AsyncDeserializeCustomMaterial>
        {
            ...
            { BVA_Material_BackLED_Extra.SHADER_NAME,BVA_Material_BackLED_Extra.Deserialize },
        ...
        public static bool ExportMaterialExtra(Material materialObj, GLTFMaterial material, ExportTextureInfo exportTextureInfo, ExportTextureInfo exportNormalMapInfo, ExportCubemapInfo exportCubemapInfo)
        {
            ...
            if (shader == BVA_Material_BackLED_Extra.SHADER_NAME)
            {
                var extra = new BVA_Material_BackLED_Extra(materialObj, exportTextureInfo, exportNormalMapInfo, exportCubemapInfo);
                material.AddExtra(BVA_Material_BackLED_Extra.PROPERTY, extra);
                return true;
            }
        ...
        public static void SetCommonMaterialKeywords(Material material)
        {
            ...
            CoreUtils.SetKeyword(material, "_ENVIRONMENTREFLECTIONS_OFF", true);
            // Emission
        ...
        class MToon
        {
            ...
            public static RenderQueueRequirement GetRenderQueueRequirement(RenderMode renderMode)
            {
                ...
                switch (renderMode)
                {
                    ...
                    default:
                        throw new System.ArgumentOutOfRangeException("renderMode", renderMode, null);
                }
            }
        }
