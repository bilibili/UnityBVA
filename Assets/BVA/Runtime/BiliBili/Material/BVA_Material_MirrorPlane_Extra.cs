...
{
public class BVA_Material_MirrorPlane_Extra : MaterialDescriptor
{
public const string PROPERTY = "BVA_Material_MirrorPlane_Extra";
public const string SHADER_NAME = "MirrorPlane";
...
public const string SKYBOX = "_Skybox";
...
public MaterialCubemapParam parameter_Skybox = new MaterialCubemapParam(SKYBOX);
...
public BVA_Material_MirrorPlane_Extra(Material material, ExportTextureInfo exportTextureInfo, ExportTextureInfo exportNormalMapInfo, ExportCubemapInfo exportCubemapInfo)
{
...
var parameter_skybox_temp = material.GetTexture(parameter_Skybox.ParamName);
if (parameter_skybox_temp != null) parameter_Skybox.Value = exportCubemapInfo(parameter_skybox_temp as Cubemap);
...
switch (curProp)
{
case BVA_Material_MirrorPlane_Extra.ALPHACUTOFF:
matCache.SetFloat(BVA_Material_MirrorPlane_Extra.ALPHACUTOFF, reader.ReadAsFloat());
break;
case BVA_Material_MirrorPlane_Extra.EMISSIONCOLOR:
matCache.SetColor(BVA_Material_MirrorPlane_Extra.EMISSIONCOLOR, reader.ReadAsRGBAColor().ToUnityColorRaw());
break;
case BVA_Material_MirrorPlane_Extra.REFLECTIONCOLOR:
matCache.SetColor(BVA_Material_MirrorPlane_Extra.REFLECTIONCOLOR, reader.ReadAsRGBAColor().ToUnityColorRaw());
break;
case BVA_Material_MirrorPlane_Extra.REFLECTIONTEXTURE:
{
var texInfo = TextureInfo.Deserialize(root, reader);
var tex = await loadTexture(texInfo.Index);
matCache.SetTexture(BVA_Material_MirrorPlane_Extra.REFLECTIONTEXTURE, tex);
}
break;
case BVA_Material_MirrorPlane_Extra.WAVETEXTURE:
{
var texInfo = TextureInfo.Deserialize(root, reader);
var tex = await loadTexture(texInfo.Index);
matCache.SetTexture(BVA_Material_MirrorPlane_Extra.WAVETEXTURE, tex);
}
break;
case BVA_Material_MirrorPlane_Extra.TILE1X:
matCache.SetFloat(BVA_Material_MirrorPlane_Extra.TILE1X, reader.ReadAsFloat());
break;
case BVA_Material_MirrorPlane_Extra.TILE1Y:
matCache.SetFloat(BVA_Material_MirrorPlane_Extra.TILE1Y, reader.ReadAsFloat());
break;
case BVA_Material_MirrorPlane_Extra.TILE2X:
matCache.SetFloat(BVA_Material_MirrorPlane_Extra.TILE2X, reader.ReadAsFloat());
break;
case BVA_Material_MirrorPlane_Extra.TILE2Y:
matCache.SetFloat(BVA_Material_MirrorPlane_Extra.TILE2Y, reader.ReadAsFloat());
break;
case BVA_Material_MirrorPlane_Extra.SKYBOX:
{
reader.Read(); reader.Read();
Cubemap cubemap = await loadCubemap(new CubemapId() { Id = reader.ReadAsInt32().Value,Root = root });
matCache.SetTexture(BVA_Material_MirrorPlane_Extra.SKYBOX, cubemap);
}
break;
case BVA_Material_MirrorPlane_Extra.QUEUEOFFSET:
matCache.SetFloat(BVA_Material_MirrorPlane_Extra.QUEUEOFFSET, reader.ReadAsFloat());
break;
case BVA_Material_MirrorPlane_Extra.QUEUECONTROL:
matCache.SetFloat(BVA_Material_MirrorPlane_Extra.QUEUECONTROL, reader.ReadAsFloat());
break;
}
}
}
...
if (parameter_Skybox != null) jo.Add(parameter_Skybox.ParamName, parameter_Skybox.Serialize());
...
return new JProperty(BVA_Material_MirrorPlane_Extra.SHADER_NAME, jo);
}
}
}
