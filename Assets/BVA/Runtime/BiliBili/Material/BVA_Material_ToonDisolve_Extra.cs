...
public MaterialParam<float> parameter_Disolve = new MaterialParam<float>(DISOLVE, 1.0f);
public MaterialParam<Color> parameter_DisolveColor = new MaterialParam<Color>(DISOLVECOLOR, Color.white);
public BVA_Material_ToonDisolve_Extra(Material material, ExportTextureInfo exportTextureInfo, ExportTextureInfo exportNormalTextureInfo, ExportCubemapInfo exportCubemapInfo)
{
...
parameter_Disolve.Value = material.GetFloat(parameter_Disolve.ParamName);
parameter_DisolveColor.Value = material.GetColor(parameter_DisolveColor.ParamName);
}
...
jo.Add(parameter_Disolve.ParamName, parameter_Disolve.Value);
jo.Add(parameter_DisolveColor.ParamName, parameter_DisolveColor.Value.ToNumericsColorRaw().ToJArray());
