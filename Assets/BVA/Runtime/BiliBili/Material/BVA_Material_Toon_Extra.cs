...
{
    [MaterialExtra]
    public class BVA_Material_Toon_Extra : IMaterialExtra
    {
        ...
        public MaterialTextureParam parameter__TicknessMap = new MaterialTextureParam(TICKNESSMAP);
        ...
        public void SetData(Material material, ExportTextureInfo exportTextureInfo, ExportTextureInfo exportNormalTextureInfo, ExportCubemap exportCubemapInfo)
        {
            ...
            var parameter__ticknessmap_temp = material.GetTexture(parameter__TicknessMap.ParamName);
            if (parameter__ticknessmap_temp != null) parameter__TicknessMap.Value = exportTextureInfo(parameter__ticknessmap_temp);
        ...
        public JProperty Serialize()
        {
            ...
            if (parameter__TicknessMap != null && parameter__TicknessMap.Value != null) jo.Add(parameter__TicknessMap.ParamName, parameter__TicknessMap.Serialize());
        ...
        public object Clone()
        {
           return new BVA_Material_Toon_Extra();
        }
    }
}
