...
{
public class BVA_Material_Toon_Extra : MaterialDescriptor
{
public const string PROPERTY = "BVA_Material_Toon_Extra";
public const string SHADER_NAME = "Shader Graphs/Toon";
...
public const string TICKNESSMAP = "_TicknessMap";
...
public MaterialTextureParam parameter_TicknessMap = new MaterialTextureParam(TICKNESSMAP);
...
public BVA_Material_Toon_Extra(Material material, ExportTextureInfo exportTextureInfo, ExportTextureInfo exportNormalTextureInfo, ExportCubemapInfo exportCubemapInfo)
{
...
var parameter_ticknessmap_temp = material.GetTexture(parameter_TicknessMap.ParamName);
if (parameter_ticknessmap_temp != null) parameter_TicknessMap.Value = exportTextureInfo(parameter_ticknessmap_temp);
...
matCache.SetTexture(BVA_Material_Toon_Extra.BASEMAP, tex);
}
break;
...
var texInfo = TextureInfo.Deserialize(root, reader);
var tex = await loadTexture(texInfo.Index);
matCache.SetTexture(BVA_Material_Toon_Extra.SSSMAP, tex);
}
break;
case BVA_Material_Toon_Extra.SMOOTHNESS:
matCache.SetFloat(BVA_Material_Toon_Extra.SMOOTHNESS, reader.ReadAsFloat());
break;
case BVA_Material_Toon_Extra.METALIC:
matCache.SetFloat(BVA_Material_Toon_Extra.METALIC, reader.ReadAsFloat());
break;
case BVA_Material_Toon_Extra.CURVATURE:
matCache.SetFloat(BVA_Material_Toon_Extra.CURVATURE, reader.ReadAsFloat());
break;
case BVA_Material_Toon_Extra.TICKNESSMAP:
{
var texInfo = TextureInfo.Deserialize(root, reader);
var tex = await loadTexture(texInfo.Index);
matCache.SetTexture(BVA_Material_Toon_Extra.TICKNESSMAP, tex);
}
break;
case BVA_Material_Toon_Extra.METALICMAP:
{
var texInfo = TextureInfo.Deserialize(root, reader);
var tex = await loadTexture(texInfo.Index);
matCache.SetTexture(BVA_Material_Toon_Extra.METALICMAP, tex);
}
break;
case BVA_Material_Toon_Extra.NORMALMAP:
{
var texInfo = TextureInfo.Deserialize(root, reader);
var tex = await loadNormalMap(texInfo.Index);
matCache.SetTexture(BVA_Material_Toon_Extra.NORMALMAP, tex);
}
break;
case BVA_Material_Toon_Extra.OCCLUSIONMAP:
{
var texInfo = TextureInfo.Deserialize(root, reader);
var tex = await loadTexture(texInfo.Index);
matCache.SetTexture(BVA_Material_Toon_Extra.OCCLUSIONMAP, tex);
}
break;
case BVA_Material_Toon_Extra.SHADE:
matCache.SetFloat(BVA_Material_Toon_Extra.SHADE, reader.ReadAsFloat());
break;
case BVA_Material_Toon_Extra.SHADEMAP:
{
var texInfo = TextureInfo.Deserialize(root, reader);
var tex = await loadTexture(texInfo.Index);
matCache.SetTexture(BVA_Material_Toon_Extra.SHADEMAP, tex);
}
break;
...
var texInfo = TextureInfo.Deserialize(root, reader);
var tex = await loadTexture(texInfo.Index);
matCache.SetTexture(BVA_Material_Toon_Extra.EMISSIONMAP, tex);
}
break;
case BVA_Material_Toon_Extra.OUTLINEWIDTH:
matCache.SetFloat(BVA_Material_Toon_Extra.OUTLINEWIDTH, reader.ReadAsFloat());
break;
case BVA_Material_Toon_Extra.OUTLINEMAP:
{
var texInfo = TextureInfo.Deserialize(root, reader);
var tex = await loadTexture(texInfo.Index);
matCache.SetTexture(BVA_Material_Toon_Extra.OUTLINEMAP, tex);
}
break;
case BVA_Material_Toon_Extra.SHADETOONY:
matCache.SetFloat(BVA_Material_Toon_Extra.SHADETOONY, reader.ReadAsFloat());
break;
case BVA_Material_Toon_Extra.TOONYLIGHTING:
matCache.SetFloat(BVA_Material_Toon_Extra.TOONYLIGHTING, reader.ReadAsFloat());
break;
case BVA_Material_Toon_Extra.OUTLINEINTENSITY:
matCache.SetFloat(BVA_Material_Toon_Extra.OUTLINEINTENSITY, reader.ReadAsFloat());
break;
}
}
}
...
if (parameter_TicknessMap != null && parameter_TicknessMap.Value != null) jo.Add(parameter_TicknessMap.ParamName, parameter_TicknessMap.Serialize());
...
return new JProperty(BVA_Material_Toon_Extra.SHADER_NAME, jo);
}
}
}
