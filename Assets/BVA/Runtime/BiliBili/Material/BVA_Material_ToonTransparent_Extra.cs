                ...
                if (reader.TokenType == JsonToken.PropertyName)
                {
                    ...
                    switch (curProp)
                    {
                        case BVA_Material_ToonTransparent_Extra.BASECOLOR:
                            matCache.SetColor(BVA_Material_ToonTransparent_Extra.BASECOLOR, reader.ReadAsRGBAColor());
                            break;
                        ...
                        case BVA_Material_ToonTransparent_Extra.SHADEENVIRONMENTALCOLOR:
                            matCache.SetColor(BVA_Material_ToonTransparent_Extra.SHADEENVIRONMENTALCOLOR, reader.ReadAsRGBAColor());
                            break;
                        case BVA_Material_ToonTransparent_Extra.SHADECOLOR:
                            matCache.SetColor(BVA_Material_ToonTransparent_Extra.SHADECOLOR, reader.ReadAsRGBAColor());
                            break;
                        ...
                        case BVA_Material_ToonTransparent_Extra.EMISSIONCOLOR:
                            matCache.SetColor(BVA_Material_ToonTransparent_Extra.EMISSIONCOLOR, reader.ReadAsRGBAColor());
                            break;
