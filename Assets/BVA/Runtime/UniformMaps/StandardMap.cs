...
namespace BVA
{
    public class StandardMap : IUniformMap
    {
        ...
        public GLTF.Schema.BlendMode BlendMode
        {
            get => _blendMode;
            set
            {
        ...
        {
            get { return _material.GetFloat("_ClearCoat"); }
            set
            {
                _material.SetFloat("_ClearCoat", (float)value);
                _material.EnableKeyword("_CLEARCOAT");
            }
        }
        public Texture ClearcoatTexture
        {
            get { return _material.HasProperty("_ClearCoatTex") ? _material.GetTexture("_ClearCoatTex") : null; }
            set
            {
                if (_material.HasProperty("_ClearCoatTex"))
                {
                    _material.SetTexture("_ClearCoatTex", value);
        ...
        {
            get { return 1.0f - _material.GetFloat("_ClearCoatSmoothness"); }
            set
            {
        ...
        {
            get { return _material.HasProperty("_ClearCoatMask") ? _material.GetTexture("_ClearCoatMask") : null; }
            set
            {
                if (_material.HasProperty("_ClearCoatMask"))
                {
                    _material.SetTexture("_ClearCoatMask", value);
                }
                else
                {
                    Debug.LogWarning("Tried to set an emission map to a material that does not support it.");
