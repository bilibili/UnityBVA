...
namespace GLTF.Schema
{
    ...
    public class GLTFRoot : GLTFProperty
    {
        ...
        /// Extensions
        /// </summary>
        public new GLTFExtensions Extensions;
        ...
        public GLTFRoot(GLTFRoot gltfRoot) : base(gltfRoot)
        {
            ...
            {
                Extensions = new GLTFExtensions(gltfRoot.Extensions, gltfRoot);
            }
        }
        ...
        public static GLTFRoot Deserialize(TextReader textReader)
        {
            ...
            {
                throw new ArgumentException("gltf json must be an object");
            }
            ...
            while (jsonReader.Read() && jsonReader.TokenType == JsonToken.PropertyName)
            {
                ...
                switch (curProp)
                {
                    ...
                    case "textures":
                        ...
                        break;
                    case "extensions":
                        root.Extensions = GLTFExtensions.Deserialize(root, jsonReader);
                        break;
                    default:
            ...
            {
                root.Extensions = new GLTFExtensions();
            }
            return root;
        }
        ...
        public void Serialize(TextWriter textWriter, bool isGLB = false)
        {
            ...
            if (Animations != null && Animations.Count > 0 && Animations[0].Channels.Count > 0 && Animations[0].Samplers.Count > 0)
            {
            ...
            if (Extensions != null && Extensions.Used)
            {
                jsonWriter.WritePropertyName("extensions");
                Extensions.Serialize(jsonWriter);
            }
