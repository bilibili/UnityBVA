...
public static class URIHelper
{
	...
	public static bool TryParseBase64(string uri, out byte[] bufferData)
	{
	...
	/// <summary>
	/// Convert an texture buffer data to Base64 string
	/// </summary>
	/// <param name="buffer"></param>
	/// <returns></returns>
	public static string ConvertImagetBase64(byte[] buffer)
    {
